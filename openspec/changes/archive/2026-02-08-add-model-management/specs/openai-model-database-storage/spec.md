...
- **WHEN** 系统创建 openai_model_configs 表
- **THEN** 表 SHALL 包含以下字段：
  - `id`: 主键（BIGINT，自增）
...
#### Scenario: 更新现有配置
- **WHEN** 用户更新现有模型配置
- **THEN** 系统 SHALL 更新 openai_model_configs 表中的对应记录
